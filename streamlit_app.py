...
# MUST match your Plaid Dashboard exactly
...
if "public_token" in st.query_params:
    ...
    # 4. Generate/Retrieve Link Token
    ...
    if link_token:
        ...
        if "oauth_state_id" in st.query_params:
            st.info("🔄 Robinhood authorization received. Finalizing...")
        ...
        # 5. The Magic Popup Breakout (Cleaned HTML)
        # Using textwrap.dedent and stripping to ensure NO leading/trailing whitespace
        raw_popup_html = textwrap.dedent(f"""
            <!DOCTYPE html>
            <html>
            <head>
                <script src="https://cdn.plaid.com/link/v2/stable/link-initialize.js"></script>
            </head>
            <body style="font-family:sans-serif;display:flex;justify-content:center;align-items:center;height:100vh;margin:0;background:#f4f4f4;">
        ...
        b64_html = base64.b64encode(raw_popup_html.encode('utf-8')).decode('utf-8')
            ...
            <body style="margin:0;padding:10px;">
                ...
                <script>
                    document.getElementById('btn').onclick = function() {{
                        ...
                        w.document.open();
                        // window.atob must receive a string with NO spaces
